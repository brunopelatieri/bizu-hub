/**
 * Brand SVG icons não disponíveis no lucide-react v1.x.
 * Cada componente aceita className para tamanho e cor via Tailwind.
 */
...
export function GitlabIcon({ className }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="m23.6 9.7-.03-.08L20.28.91a.86.86 0 0 0-.86-.61.84.84 0 0 0-.8.61l-3.14 9.56H8.53L5.38.91a.85.85 0 0 0-.8-.61.86.86 0 0 0-.86.61L.4 9.62l-.03.08a6.1 6.1 0 0 0 2.02 7.04l.01.01.03.02 5 3.74 2.47 1.87 1.51 1.14a1 1 0 0 0 1.2 0l1.51-1.14 2.47-1.87 5.04-3.76.01-.01A6.1 6.1 0 0 0 23.6 9.7z" />
    </svg>
  );
}
